  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        {/* Prose content — intro + 11 sections */}
        <div className="space-y-8 animate-pulse">
          ...
          {/* Sections */}
          {[
            { heading: 'w-64', lines: 4 },
            { heading: 'w-48', lines: 3 },
            { heading: 'w-40', lines: 3 },
            { heading: 'w-72', lines: 4 },
            { heading: 'w-80', lines: 5 },
            { heading: 'w-44', lines: 4 },
            { heading: 'w-52', lines: 4 },
            { heading: 'w-36', lines: 2 },
            { heading: 'w-40', lines: 2 },
            { heading: 'w-56', lines: 2 },
            { heading: 'w-32', lines: 3 },
          ].map((s, i) => (
